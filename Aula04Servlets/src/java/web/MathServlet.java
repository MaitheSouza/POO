    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                out.println("<div>" +"Parâmetros inválidos"+ "</div>");
            }
            out.println("<form>\n" +
            "            <input type='number' step='0.1' name='n1' value='"+n1+"'/> +\n" +
            "            <input type='number' step='0.1' name='n1' value='"+n2+"'/> +\n"+
            "            <input type='submit' name='calcular' value='='/>\n" +
            "        </form>");
            out.println("<h2>"+n1+" + "+n2+" = "+(resultado)+ "</h2>");
            out.println("</body>");
            out.println("</html>");
        }
    }
